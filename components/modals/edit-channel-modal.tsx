...
import { updateChannel } from "@/lib/firebase-querys";
...
export const EditChannelModal = () => {
  ...
  const { spaceId, roomId, channel } = data;
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    if (spaceId && roomId && channel) {
      const channelData = {
        name: values.name,
        type: values.type,
      };

      await updateChannel(spaceId, roomId, channel.id, channelData);
